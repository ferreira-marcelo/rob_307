...
HD_PWD='/home/fabian/vivado/hardware_arm_only/hardware_arm_only.runs/arm_timer_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_timer_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_timer_rst_ps7_0_100M_0.tcl
