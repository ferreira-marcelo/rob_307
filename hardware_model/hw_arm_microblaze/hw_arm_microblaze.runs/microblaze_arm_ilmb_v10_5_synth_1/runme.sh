...
HD_PWD='/home/fabian/Documents/ensta/deuxieme/rob307/rob_307/hardware_model/hw_arm_microblaze/hw_arm_microblaze.runs/microblaze_arm_ilmb_v10_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_arm_ilmb_v10_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_arm_ilmb_v10_5.tcl
