...
HD_PWD='/home/fabian/Documents/ensta/deuxieme/rob307/rob_307/hardware_model/hw_arm_microblaze/hw_arm_microblaze.runs/microblaze_arm_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_arm_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_arm_auto_pc_0.tcl
